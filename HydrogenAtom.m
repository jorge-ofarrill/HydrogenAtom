...
figure('Name', 'Hydrogen Atom', 'Color', 'k', 'Position', [200, 200, 800, 600]);
axis equal
...
% Nested functions for computation and updates
    ...
    function visualizeSlices()
        ...
        axis equal tight; axis off; colormap(cool); 
        set(gca, 'YDir', 'normal'); title('Slice at x=0');
        
        subplot(132), imagesc(x, z, slice_datay');
        axis equal tight; axis off; colormap(cool); 
        set(gca, 'YDir', 'normal'); title('Slice at y=0');

        subplot(133), imagesc(x, y, slice_dataz');
        axis equal tight; axis off; colormap(cool); 
        set(gca, 'YDir', 'normal'); title('Slice at z=0');
    end
